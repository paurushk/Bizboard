...
**Sequencing (demand-gated):** **7.0 Tally import/export** → **7.1 WhatsApp Business API** → **7.2 Multi-company / multi-branch** → **7.3 POS + recurring** → **7.4 PAN / GSTIN / UDYAM verify**. Busy/Zoho only on demand. ONDC / DigiLocker / Aadhaar eSign / Manufacturing BOM = **Future**.

At solo headcount: **~26–33 weeks** if 7.0–7.4 are all sequential; prefer **7.0 + 7.1 + 7.4** in year one unless a multi-GSTIN deal forces 7.2.
