...
const MOCK_FLAGS: RuntimeFeatureFlags = {
  ...
  ENABLE_GST_GUARD: false,
  ENABLE_ROUTE_PROFIT: false,
  ENABLE_SUPPLIER_PRICE_HISTORY: false,
  ENABLE_CUSTOMER_PORTAL: false,
  ENABLE_ACTION_ASSIGNMENT: false,
  ENABLE_PREDICTIVE_DUNNING: false,
  ENABLE_CUSTOMER_360: false,
