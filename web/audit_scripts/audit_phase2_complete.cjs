...
async function runPhase2() {
  ...
  try {
    ...
    // Quick add supplier on Purchase Page via "+ New Supplier"
    const newSuppLink = page.locator('button:has-text("+ New Supplier"), a:has-text("+ New Supplier")').first();
    if (await newSuppLink.isVisible()) {
      await newSuppLink.click();
      await page.waitForTimeout(500);
      ...
      await page.locator('div[role="dialog"] label:has-text("State")').locator('..').locator('input').first().fill('Maharashtra');
    ...
    if (await addItemLink.isVisible()) {
      ...
      await page.waitForTimeout(500);
      await page.locator('div[role="dialog"] label:has-text("Item Name")').locator('..').locator('input').first().fill('UXWAVE2-Item-Widget');
      await page.locator('div[role="dialog"] label:has-text("SKU")').locator('..').locator('input').first().fill(testSku + '-P');
      await page.locator('div[role="dialog"] label:has-text("Purchase Price")').locator('..').locator('input').first().fill('100');
    ...
    if (!await purchaseSaveAction.isDisabled()) {
    ...
    // Quick add customer on Sales Page via "+ New Customer"
    ...
    if (await newCustLink.isVisible()) {
      ...
      await page.locator('div[role="dialog"] label:has-text("GSTIN")').locator('..').locator('input').first().fill('29ABCDE1234F1Z5');
      await page.locator('div[role="dialog"] label:has-text("Phone")').locator('..').locator('input').first().fill('9876501234');
    ...
    // Add Product: Click "+ Add Item"
    const addSaleItemLink = page.locator('button:has-text("+ Add Item"), a:has-text("+ Add Item")').first();
    if (await addSaleItemLink.isVisible()) {
      await addSaleItemLink.click();
      await page.waitForTimeout(500);
      await page.locator('div[role="dialog"] label:has-text("Item Name")').locator('..').locator('input').first().fill('UXWAVE2-Item-Widget');
      await page.locator('div[role="dialog"] label:has-text("SKU")').locator('..').locator('input').first().fill(testSku + '-S');
      await page.locator('div[role="dialog"] label:has-text("Selling Price")').locator('..').locator('input').first().fill('150');
      await page.locator('div[role="dialog"] button:has-text("Add")').first().click();
      await page.waitForTimeout(1000);
    }
    ...
    if (!await salesSaveAction.isDisabled()) {
