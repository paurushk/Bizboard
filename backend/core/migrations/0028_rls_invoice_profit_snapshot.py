"""Enroll reporting_invoiceprofitsnapshot in tenant RLS.

`0020` lists the table for coverage tests; this catch-up applies the same
idempotent ENABLE/FORCE/POLICY SQL after `reporting.0014` creates it.
"""

from django.db import migrations

RLS_TABLES = ["reporting_invoiceprofitsnapshot"]
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0027_rls_billing_deadletter"),
        ("reporting", "0014_invoiceprofitsnapshot"),
    ]
