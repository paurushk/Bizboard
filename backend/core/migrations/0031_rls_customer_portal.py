"""Enroll the customer portal token table in tenant RLS.

Created in payments/migrations/0031 after 0020 listed tenant tables, so this
catch-up applies the same idempotent policy. 0020 lists the table name so
coverage tests recognize it.
"""
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0030_rls_sales_purchase_ux"),
        ("payments", "0031_customer_portal_token"),
    ]
