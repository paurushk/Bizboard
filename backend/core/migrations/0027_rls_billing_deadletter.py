"""Enroll billing_subscription and billing_deadletterevent in tenant RLS.

`0020` lists the tables for coverage tests; this catch-up applies the same
idempotent ENABLE/FORCE/POLICY SQL after `billing.0005` creates them.
"""

from django.db import migrations

RLS_TABLES = ["billing_deadletterevent", "billing_subscription"]
