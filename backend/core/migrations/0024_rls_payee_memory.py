"""QOS-0043 / RLS coverage: `payments.PayeeMemory` is a new tenant (`company`
FK) table added after 0020_rls_all_tenant_tables.py ran, so it was never
enrolled — tests/test_rls_coverage.py flags any such table missing from the
RLS policy set. Same idempotent, Postgres-only, no-op-on-SQLite pattern as
0020/0022/0023.
"""

from django.db import migrations

RLS_TABLES = ["payments_payeememory"]
