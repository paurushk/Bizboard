# Backfill blank HSN/UQC snapshots on purchase invoice and CN/DN lines from product/unit.
...
def _backfill(apps, schema_editor):
    ...
    PurchaseCreditNoteItem = apps.get_model("purchases", "PurchaseCreditNoteItem")
    PurchaseDebitNoteItem = apps.get_model("purchases", "PurchaseDebitNoteItem")
    for model in (PurchaseItem, PurchaseCreditNoteItem, PurchaseDebitNoteItem):
        fill_lines(model)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("purchases", "0007_phase2_gap_inclusive_price"),
