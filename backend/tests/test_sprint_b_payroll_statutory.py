...
def test_compute_pf_esi_pt_known_fixture(tenant_a):
    ...
    assert computed["esi_employee"] == Decimal("375.00")  # 0.75% of 50000
    assert computed["pt_amount"] == Decimal("200.00")
    assert computed["deductions"] == Decimal("2375.00")
    assert computed["net"] == Decimal("47625.00")
    assert computed["pf_employer"] == Decimal("1800.00")
    assert computed["esi_employer"] == Decimal("1625.00")  # 3.25% of 50000
...
def test_complete_pay_run_persists_statutory_and_posts_gross_split(tenant_a):
    ...
    assert slip.esi_employee == Decimal("375.00")
    assert slip.pt_amount == Decimal("200.00")
    assert slip.net == Decimal("47625.00")
    ...
    assert codes["5800"][0] == Decimal("50000.00")
    assert codes["2261"][1] == Decimal("1800.00")
    assert codes["2262"][1] == Decimal("375.00")
    assert codes["2263"][1] == Decimal("200.00")
    assert codes["1100"][1] == Decimal("47625.00")
