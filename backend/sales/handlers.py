...
def _enqueue(task, pk):
    if settings.CELERY_TASK_ALWAYS_EAGER:
        task.delay(pk)
    else:
        transaction.on_commit(lambda: task.delay(pk))
